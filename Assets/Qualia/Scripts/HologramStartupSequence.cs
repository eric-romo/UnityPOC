...
public class HologramStartupSequence : MonoBehaviour {
	...
	void Start () {
		...
		holographicDisplay.GetComponent<DisplayController>().LoadUrl("coui://UIResources/Qualia/HolographicChess/index.html");
